...
export default {
  ...
  SIGNIN_HEADING: "Continue With Ai App Maker",
  SIGNIN_SUBHEADING:
    "To use Ai App Maker you must log into an existing account or create one.",
  SIGNIn_AGREEMENT_TEXT:
    "By using Ai App Maker, you agree to the collection of usage data for analytics.",
